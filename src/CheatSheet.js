...
export default function CheatSheet() {
    return (
        <div id={'CheatSheet'}>
            ...
            <Typography variant="h5">Welcome to the Navigation Room</Typography>
                <div className='blockText'>
                Hello, Navigators! Here are some important coding concepts that will
                come in handy as your team works through the escape room.
                </div>
                <br/>
